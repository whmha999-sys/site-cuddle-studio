...
export function PrivacyPage({ lang }) {
  return (
    ...
    >
      ...
      <p>{tx(lang, 'You may request access, correction, or deletion of your personal data at any time by contacting support@smartleaders.jo.', 'يحق لك طلب الاطلاع على بياناتك أو تصحيحها أو حذفها بالتواصل مع support@smartleaders.jo.')}</p>
    </PageShell>
  );
}
