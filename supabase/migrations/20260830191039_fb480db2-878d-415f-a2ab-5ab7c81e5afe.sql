...
BEGIN
  ...
  LOOP
    ...
    SELECT p.price INTO v_price FROM public.products p WHERE p.id = v_pid AND p.active = true AND p.sold_out = false;
    IF v_price IS NULL THEN
      RAISE EXCEPTION 'Product unavailable: %', v_pid;
    END IF;
